...
$arguments += @("$PSScriptRoot\Probe.cs", "$PSScriptRoot\MouseDevice.cs", "$PSScriptRoot\FirmwareUpdates.cs", "$PSScriptRoot\FirmwareSupport.cs", "$PSScriptRoot\Controller.cs", "$PSScriptRoot\Controller.Device.cs", "$PSScriptRoot\App.cs")
